            ...
            switch (v.getId()) {
                ...
                case R.id.btn_submit:
                    try {
                        ...
                        if (result.equals("idVal")){
                            ...
                            Toast.makeText(PassengerJoinActivity.this, getString(R.string.phoneNotConfirmed), Toast.LENGTH_SHORT).show();
                        }
                            ...
                            Toast.makeText(PassengerJoinActivity.this, getString(R.string.phoneExist), Toast.LENGTH_SHORT).show();
                        }
                ...
                case R.id.btn_auth:
                    if (et_middle.getText().toString().length() != 4 ||
                        ...
                        Toast.makeText(PassengerJoinActivity.this, "전화번호 8자리를 모두 입력해주세요.", Toast.LENGTH_SHORT).show();
                        return;
                    }
                    ...
                    Toast.makeText(PassengerJoinActivity.this, "인증번호를 전송했습니다.", Toast.LENGTH_SHORT).show();
                ...
                case R.id.btn_authconfirm:
                    ...
                    try {
                        ...
                        if (res.equals("success")){
                            ...
                            Toast.makeText(PassengerJoinActivity.this, "인증에 성공하였습니다.", Toast.LENGTH_SHORT).show();
                        }
                        else if (res.equals("fail")){
                            Toast.makeText(PassengerJoinActivity.this, "인증번호가 일치하지 않습니다.", Toast.LENGTH_SHORT).show();
                        }
