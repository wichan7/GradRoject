        ...
        public void onClick(View v) {
            switch (v.getId()){
                case R.id.btn_cancel:
                    ...
                    Toast.makeText(PassengerWaitingActivity.this,"콜을 취소하셨습니다.",Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(PassengerWaitingActivity.this, PassengerCallActivity.class);
                    startActivity(intent);
                    finish();
                    break;
            }
